...
class HDPrivateKey {
  ...
  fromSeed(seed) {
    ...
    this.publicKey = keys.pub;//secp256k1.publicKeyCreate(left, true);
  ...
  fromKey(key, entropy) {
    ...
    this.privateKey = key;
    this.publicKey = falcon.privToPub(key); //secp256k1.publicKeyCreate(key, true);
    return this;
  }
  ...
  fromReader(br, network) {
    ...
    this.publicKey = falcon.privToPub(this.privateKey); //secp256k1.publicKeyCreate(this.privateKey, true);
