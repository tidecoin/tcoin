...
class HDPublicKey {
  ...
  fromReader(br, network) {
    ...
    this.publicKey = br.readBytes(policy.PUBKEY_SIZE);
  ...
  toRaw(network) {
    // return this.toWriter(bio.write(49+policy.PUBKEY_SIZE), network).render();
    return this.toWriter(bio.write(65+policy.PUBKEY_SIZE), network).render();
